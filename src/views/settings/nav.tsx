...
const SETTINGS_OPTIONS: SettingsOption[] = [
  ...
  { label: "Fullscreen clock", section: "playerLayout", anchorTitle: "Fullscreen clock", keywords: ["fullscreen clock", "local time", "player clock", "clock format", "clock style"] },
  ...
  { label: "Episode ordering (TVDB, DVD, absolute, arc order)", section: "library", anchorTitle: "Episode order", keywords: ["episode ordering", "episode order", "tvdb order", "dvd order", "absolute order", "aired order", "official order", "arc order", "one piece order", "season order", "tvdb season and order panel", "order tabs", "reorder episodes"] },
  ...
  { label: "AudD · in-player song ID", section: "library", anchorTitle: "Song identification", keywords: ["audd", "song recognition", "music id", "api token", "identify song key"] },
  ...
  { label: "Prefer my installed metadata addon", section: "library", anchorTitle: "Titles and descriptions", keywords: ["meta addon", "localized cinemeta", "custom metadata", "override cinemeta", "descriptions"] },
  ...
  { label: "Show fullscreen clock", section: "playerLayout", anchorTitle: "Fullscreen clock", keywords: ["local time", "player clock", "fullscreen time", "show clock", "hide clock"] },
  { label: "Clock format", section: "playerLayout", anchorTitle: "Fullscreen clock", keywords: ["12 hour", "24 hour", "am pm", "system time", "seconds"] },
  { label: "Clock size", section: "playerLayout", anchorTitle: "Fullscreen clock", keywords: ["clock pixels", "larger clock", "smaller clock", "resize time", "font size"] },
  { label: "Show estimated finish time", section: "playerLayout", anchorTitle: "Fullscreen clock", keywords: ["ends at", "finish time", "movie end", "episode end", "estimated end"] },
  { label: "Clock style", section: "playerLayout", anchorTitle: "Fullscreen clock", keywords: ["glass", "minimal", "solid", "accent", "clock design"] },
...
{ label: "Lock to season server", section: "basics", anchorTitle: "When you press Play", keywords: ["season lock","season server","season pack","same source","lock source","no re-picking","play mode","sticky season","debrid season pack","lock series"] },
  ...
  { label: "Use live web context (Jina Reader)", section: "library", anchorTitle: "Live web", keywords: ["live web","jina","jina reader","web context","duckduckgo","web search ai","current results"] },
  { label: "Jina API key", section: "library", anchorTitle: "Live web", keywords: ["jina key","jina api","reader key","web quota","jina token"] },
  { label: "Use free IMDb data without a TMDB key", section: "library", anchorTitle: "Titles and descriptions", keywords: ["imdb fallback","free imdb","no tmdb key","imdb data","cast crew","about panel","imdb source"] },
  { label: "Song ID provider (AudD / Gemini)", section: "library", anchorTitle: "Song identification", keywords: ["song id provider","audd","gemini","music recognition provider","identify song source","shazam alternative"] },
  { label: "Gemini · in-player song ID", section: "library", anchorTitle: "Song identification", keywords: ["gemini","google gemini","song id key","music id","gemini api key","aistudio","identify song"] },
  ...
  { label: "Test controller", section: "controllers", anchorTitle: "Controller support", keywords: ["test controller", "test mode", "controller test", "try controller", "check buttons", "controller selecting things", "stop controller navigating", "capture controller"] },
  { label: "Controller cursor", section: "controllers", anchorTitle: "Controller cursor", keywords: ["cursor", "pointer", "dot", "controller cursor", "cursor image", "custom cursor", "harbor logo cursor", "boat cursor", "cursor size"] },
  { label: "Your own image", section: "controllers", anchorTitle: "Controller cursor", keywords: ["custom cursor", "upload cursor", "cursor image", "replace cursor"] },
  { label: "Cursor size", section: "controllers", anchorTitle: "Controller cursor", keywords: ["cursor size", "bigger cursor", "smaller pointer", "cursor px"] },
  ...
  { label: "Watchlist bookmark", section: "library", anchorTitle: "On the poster", keywords: ["bookmark", "watchlist marker", "saved marker", "corner bookmark"] },
  { label: "Max scores per card", section: "library", anchorTitle: "Scores", keywords: ["badge limit", "how many ratings", "score count", "too many badges"] },
  ...
  { label: "Show an on disk badge on cards", section: "library", anchorTitle: "On the poster", keywords: ["on disk", "local file badge", "downloaded badge", "have it locally"] },
  ...
  { label: "Bookmark corner", section: "library", anchorTitle: "On the poster", keywords: ["bookmark corner", "marker position", "watchlist corner", "which corner"] },
